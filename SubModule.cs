...
namespace SortedIncome
{
    public class SubModule : MBSubModuleBase
    {
        ...
        protected override void OnBeforeInitialModuleScreenSetAsRoot()
        {
            ...
            if (Sorting.AddLine != null && Sorting.Value != null && Sorting.TextObjectStrs.Count > 0)
                InformationManager.DisplayMessage(new InformationMessage("Sorted Income initialized", Colors.Yellow, "SortedIncome"));
            else
                InformationManager.DisplayMessage(new InformationMessage("Sorted Income failed to initialize", Colors.Red, "SortedIncome"));
        }
    }
}